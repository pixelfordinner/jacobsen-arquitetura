...
@section('main')
    ...
    <p>Jacobsen Arquitetura uses two main fonts: <a href="https://www.myfonts.com/fonts/emtype/geogrotesque/" target="_blank">Geogrotesque</a> and <a href="https://typekit.com/fonts/expo-serif-pro" target="_blank">Expo Serif Sans</a>.<br> Modular scales are used to setup heading and body text base sizes, along with being responsive to every screen size<br> Vertical Rhythm along with baseline set on x-height are used to achieve maximum readability and clarity.<br> Lastly, font-kerning, ligatures are activated once the fonts are loaded.</p>

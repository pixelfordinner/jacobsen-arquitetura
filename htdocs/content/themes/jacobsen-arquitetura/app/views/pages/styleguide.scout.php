...
@section('main')
            <div class="container">
                ...
                <div class="row row--padded">
                    ...
                    <a href="#" class="button uppercase">{{ Macros::symbol('symbols-download', 'Download', array('button__symbol')) }}Presskit</a>
                    ...
                    <a href="#" class="button button--small uppercase">{{ Macros::symbol('symbols-download', 'Download', array('button__symbol')) }}Presskit</a>
                    ...
                    <div class="button__group" role="group" aria-label="Button group with icons example">
                        <button class="button uppercase">{{ Macros::symbol('symbols-download', 'Language', array('button__symbol')) }}FR</button>
                        <button class="button uppercase">{{ Macros::symbol('symbols-download', 'Language', array('button__symbol')) }}EN</button>
                        <button class="button uppercase">{{ Macros::symbol('symbols-download', 'Language', array('button__symbol')) }}PT</button>
                    </div>

                    <br>

                    <div class="button__group" role="group" aria-label="Small button group with icons example">
                        <button class="button button--small uppercase">{{ Macros::symbol('symbols-marker', 'Language', array('button__symbol')) }}FR</button>
                        <button class="button button--small uppercase">{{ Macros::symbol('symbols-marker', 'Language', array('button__symbol')) }}EN</button>
                        <button class="button button--small uppercase">{{ Macros::symbol('symbols-marker', 'Language', array('button__symbol')) }}PT</button>
                    </div>
                </div>
                <div class="row row--padded">
